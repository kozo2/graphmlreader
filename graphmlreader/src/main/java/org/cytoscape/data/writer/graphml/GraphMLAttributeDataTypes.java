...
public enum GraphMLAttributeDataTypes {
	BOOLEAN("boolean", Boolean.class), INTEGER("int", Integer.class), LONG("long", Long.class), FLOAT("float", Float.class), DOUBLE(
			"double", Double.class), STRING("string", String.class);
